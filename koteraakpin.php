...
function change(){
        ...
        echo "\n".color("yellow","!] Claim voc Jogja/Solo");
        ...
        echo "\n".color("yellow","!] Claim voc PESANGOFOD2206");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        sleep(3);
        $boba19 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PESANGOFOD2206"}');
        ...
        echo "\n".color("yellow","!] Claim voc PAKEGOFOOD2206");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
